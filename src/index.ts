...
const MIXPANEL_EU_API_URL = "https://api-eu.mixpanel.com";
...
export class ExpoMixpanelAnalytics {
    ...
    constructor(token, eu, storageKey = "mixpanel:super:props") {
        this.storageKey = storageKey;
        this.apiUrl = eu ? MIXPANEL_EU_API_URL : MIXPANEL_API_URL;
        this.token = token;
        this.userId = null;
